...
static EmailCommonStringType EMAIL_COMPOSER_STRING_BUTTON_SAVE_ABB = { PACKAGE, "IDS_EMAIL_BUTTON_SAVE_ABB" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_BUTTON_DISCARD_ABB2 = { PACKAGE, "IDS_EMAIL_BUTTON_DISCARD_ABB2" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_BUTTON_CONTINUE_ABB = { PACKAGE, "IDS_EMAIL_BUTTON_CONTINUE_ABB" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_HEADER_STOP_COMPOSING_EMAIL_HEADER_ABB = { PACKAGE, "IDS_EMAIL_HEADER_STOP_COMPOSING_EMAIL_HEADER_ABB" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_HEADER_DOWNLOAD_ATTACHMENTS_ABB = { PACKAGE, "IDS_EMAIL_HEADER_DOWNLOAD_ATTACHMENTS_ABB" };
...
static EmailCommonStringType EMAIL_COMPOSER_STRING_POP_SAVE_YOUR_CHANGES_OR_DISCARD_THEM_Q = { PACKAGE, "IDS_EMAIL_POP_SAVE_YOUR_CHANGES_OR_DISCARD_THEM_Q" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_POP_ALL_ATTACHMENTS_IN_THIS_EMAIL_WILL_BE_DOWNLOADED_BEFORE_IT_IS_FORWARDED = { PACKAGE, "IDS_EMAIL_POP_ALL_ATTACHMENTS_IN_THIS_EMAIL_WILL_BE_DOWNLOADED_BEFORE_IT_IS_FORWARDED" };
...
static EmailCommonStringType EMAIL_COMPOSER_STRING_MF_HEADER_UNABLE_TO_SAVE_DATA_ABB = { PACKAGE, "IDS_MF_HEADER_UNABLE_TO_SAVE_DATA_ABB" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_STORAGE_FULL_CONTENTS = { PACKAGE, "IDS_EMAIL_POP_THERE_IS_NOT_ENOUGH_SPACE_IN_YOUR_DEVICE_STORAGE_GO_TO_SETTINGS_POWER_AND_STORAGE_STORAGE_THEN_DELETE_SOME_FILES_AND_TRY_AGAIN" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_BUTTON_SETTINGS = { PACKAGE, "IDS_EMAIL_BUTTON_SETTINGS" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_HEADER_UNABLE_TO_PERFORM_ACTION_ABB = { PACKAGE, "IDS_EMAIL_HEADER_UNABLE_TO_PERFORM_ACTION_ABB" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_POP_SAVING_EMAIL_ING = { PACKAGE, "IDS_EMAIL_POP_SAVING_EMAIL_ING" };
