...
static EmailCommonStringType EMAIL_COMPOSER_STRING_VCARD_CREATE_FILED = { PACKAGE, "IDS_EMAIL_POP_THE_VCARD_HAS_NOT_BEEN_CREATED_AN_UNKNOWN_ERROR_HAS_OCCURRED" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_UABLE_TO_COMPOSE_EMAIL_MESSAGE = { PACKAGE, "IDS_EMAIL_HEADER_UNABLE_TO_COMPOSE_EMAIL_ABB" };
static EmailCommonStringType EMAIL_COMPOSER_STRING_THERE_IS_NO_ACCOUNT_CREATE_A_NEW_ACCOUNT_FIRST = { PACKAGE, "IDS_EMAIL_POP_TO_COMPOSE_AN_EMAIL_CREATE_AN_EMAIL_ACCOUNT" };
...
static void _composer_contacts_update_recp_info_for_mbe(EmailComposerUGD *ugd, Evas_Object *mbe)
{
	...
	while (item) {
		...
		EMAIL_CONTACT_LIST_INFO_S *contact_list_item = email_contact_search_by_email(ugd, selected_ai->address);
