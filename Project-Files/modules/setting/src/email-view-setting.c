...
static email_setting_string_t EMAIL_SETTING_STRING_DEFAULT_SENDING_ACCOUNT = {PACKAGE, "IDS_EMAIL_TMBODY_DEFAULT_SENDING_ACCOUNT"};
static email_setting_string_t EMAIL_SETTING_STRING_ACCOUNT = {PACKAGE, "IDS_EMAIL_HEADER_ACCOUNTS"};
static email_setting_string_t EMAIL_SETTING_STRING_EMAIL_SETTINGS = {PACKAGE, "IDS_EMAIL_HEADER_SETTINGS"};
static email_setting_string_t EMAIL_SETTING_STRING_GENERAL_SETTINGS = {PACKAGE, "IDS_EMAIL_HEADER_GENERAL"};
static email_setting_string_t EMAIL_SETTING_STRING_PRIORITY_SENDERS = {PACKAGE, "IDS_EMAIL_MBODY_PRIORITY_SENDERS"};
static email_setting_string_t EMAIL_SETTING_STRING_ADD_ACCOUNT = {PACKAGE, "IDS_EMAIL_OPT_ADD_ACCOUNT"};
...
static email_setting_string_t EMAIL_SETTING_STRING_NO_ACCOUNT = {PACKAGE, "IDS_EMAIL_POP_YOU_HAVE_NOT_YET_CREATED_AN_EMAIL_ACCOUNT_CREATE_AN_EMAIL_ACCOUNT_AND_TRY_AGAIN"};
