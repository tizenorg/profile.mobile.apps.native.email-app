...
static email_setting_string_t EMAIL_SETTING_STRING_EMAIL_NOTI = {PACKAGE, "IDS_EMAIL_MBODY_EMAIL_NOTIFICATIONS"};
static email_setting_string_t EMAIL_SETTING_STRING_EMAIL_NOTI_HELP = {PACKAGE, "IDS_EMAIL_SBODY_RECEIVE_STATUS_BAR_NOTIFICATIONS_WHEN_EMAILS_ARRIVE"};
static email_setting_string_t EMAIL_SETTING_STRING_VIBRATE = {PACKAGE, "IDS_EMAIL_MBODY_VIBRATION"};
static email_setting_string_t EMAIL_SETTING_STRING_NOTI_SOUND = {PACKAGE, "IDS_EMAIL_MBODY_NOTIFICATION_SOUND"};
static email_setting_string_t EMAIL_SETTING_STRING_DEFAULT_RINGTONE = {PACKAGE, "IDS_ST_OPT_DEFAULT_RINGTONE"};
static email_setting_string_t EMAIL_SETTING_STRING_SILENT_RINGTONE = {PACKAGE, "IDS_ST_BODY_SILENT"};
