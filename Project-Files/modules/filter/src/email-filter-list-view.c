...
static email_filter_string_t EMAIL_FILTER_STRING_ADD = {PACKAGE, "IDS_EMAIL_OPT_ADD"};
static email_filter_string_t EMAIL_FILTER_STRING_REMOVE = {PACKAGE, "IDS_EMAIL_OPT_REMOVE"};
static email_filter_string_t EMAIL_FILTER_STRING_NO_PRIORITY_SENDERS_HELP = {PACKAGE, "IDS_EMAIL_BODY_AFTER_YOU_ADD_PRIORITY_SENDERS_THEY_WILL_BE_SHOWN_HERE"};
static email_filter_string_t EMAIL_FILTER_STRING_PRIORITY_SENDERS = {PACKAGE, "IDS_EMAIL_HEADER_PRIORITY_SENDERS_ABB"};
